...
class BERT_BILSTM_CRF_KB_NER(nn.Module):
    ...
    def __init__(self, bert_model, start_label_id, stop_label_id, num_labels, max_seq_length, batch_size, device):
        ...
        # Adjusted
        self.rnn = nn.LSTM(bidirectional=True, num_layers=2, input_size=768, hidden_size=778 // 2, batch_first=True)
    ...
    def forward(self, input_ids, onto_labels, db_labels, segment_ids, input_mask):
        ...
        return score, label_seq_ids, bert_feats
