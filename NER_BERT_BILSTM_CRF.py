...
'''
print('*** Use BertModel + BILSTM + CRF ***')
...
# %%
if load_checkpoint and os.path.exists(output_dir + '/ner_bert_bilstm_crf_checkpoint.pt'):
    checkpoint = torch.load(output_dir + '/ner_bert_bilstm_crf_checkpoint.pt', map_location='cpu')
    ...
    print('Loaded the pretrain NER_BERT_BILSTM_CRF model, epoch:', checkpoint['epoch'], 'valid acc:',
...
for epoch in range(start_epoch, total_train_epochs):
    ...
    if valid_f1 > valid_f1_prev:
        ...
        torch.save({'epoch': epoch, 'model_state': model.state_dict(), 'valid_acc': valid_acc,
                   ...
                   os.path.join(output_dir, 'ner_bert_bilstm_crf_checkpoint.pt'))
